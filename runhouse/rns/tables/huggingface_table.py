...
class HuggingFaceTable(Table):
    ...
    def stream(self, batch_size: int, drop_last: bool = False, shuffle_seed: Optional[int] = None,
        ...
        for batch in super().stream(batch_size, drop_last, shuffle_seed, shuffle_buffer_size, prefetch_blocks):
    ...
    def to_dataset(data):
        ...
        if not isinstance(data, pd.DataFrame):
            raise TypeError(f'Data must be a dict, Pandas DataFrame, ray Dataset, or PyArrow table, not {type(data)}')
