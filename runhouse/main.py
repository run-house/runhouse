...
def _print_envs_info(
    worker_servlet_processes: Dict[str, Dict[str, Any]], current_cluster: Cluster
):
    """
    ...
    env_resource_mapping = {
        env: worker_servlet_processes[env]["env_resource_mapping"]
        for env in worker_servlet_processes
    }
    ...
    for env_name in envs_to_print:
        ...
        env_process_info = worker_servlet_processes[env_name]
...
def _print_status(status_data: dict, current_cluster: Cluster) -> None:
    ...
    worker_servlet_processes = status_data.get("worker_servlet_processes")
    ...
    _print_envs_info(worker_servlet_processes, current_cluster)
