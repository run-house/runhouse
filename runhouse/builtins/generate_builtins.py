...
rh_cpu = SkyCluster(name='^rh-cpu', instance_type='m5.large', provider='aws', dryrun=False)
rh_8_cpu = SkyCluster(name='^rh-8-cpu', instance_type='m5.2xlarge', provider='aws', dryrun=False)
rh_32_cpu = SkyCluster(name='^rh-32-cpu', instance_type='m5.8xlarge', provider='aws', dryrun=False)
