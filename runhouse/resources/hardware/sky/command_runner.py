# Source: https://github.com/skypilot-org/skypilot/blob/465d36/sky/utils/command_runner.py
...
from runhouse.resources.hardware.sky import (
    constants,
    common_utils,
    log_lib,
    subprocess_utils,
)
from runhouse.constants import DISK_OUT_OF_SPACE_MSG
...
class CommandRunner:
    ...
    def _rsync(
        ...
        if DISK_OUT_OF_SPACE_MSG not in stderr:
