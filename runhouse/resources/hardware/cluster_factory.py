    ...
    **kwargs,
    ...
    Args:
        ...
        default_env (Env or str, optional): Environment that the Runhouse server is started on in the cluster. Used to
            ...
            server. (Default: ``None``)
        load_from_den (bool): Whether to try loading the Cluster from Den. (Default: ``True``)
    ...
    **kwargs,
    ...
    Args:
        ...
        default_env (Env or str, optional): Environment that the Runhouse server is started on in the cluster. Used to
            specify an isolated environment (e.g. conda env) or any setup and requirements prior to starting the Runhouse
            server. (Default: ``None``)
        load_from_den (bool): Whether to try loading the SageMakerCluster from Den. (Default: ``True``)
