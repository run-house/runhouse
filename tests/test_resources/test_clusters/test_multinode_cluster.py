...
class TestMultiNodeCluster:
    ...
    def test_specifying_resources(self, multinode_cpu_docker_conda_cluster):
        ...
        env0_node = status["worker_servlet_processes"][env0.name]["node_ip"]
        env1_node = status["worker_servlet_processes"][env1.name]["node_ip"]
        env2_node = status["worker_servlet_processes"][env2.name]["node_ip"]
        env3_node = status["worker_servlet_processes"][env3.name]["node_ip"]
